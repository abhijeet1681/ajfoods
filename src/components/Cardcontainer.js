...
//                 return <Restaurantcard name={elements.info.name} areaName={elements.info.areaName} avgRating={elements.info.avgRating} cuisines={elements.info.cuisines} />
//             })
