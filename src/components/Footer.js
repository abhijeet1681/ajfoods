...
//                   <section className="d-flex justify-content-between p-4 mt-3" style={{backgroundColor:"#f37759"}} >
//                   {/* <section className="d-flex justify-content-between p-4 mt-3" style={{backgroundColor:"#f97c20"}} > */}

//                   <div className="me-5">
//                   <span>For better experience,download<br></br>the Swiggy app now</span>
//                       </div>
...
const Footer = () => {
    return(
      <div>
        ...
        <h3>For better experience,download<br></br>the Swiggy app now</h3>
        <span>
        <img className="playstore" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/m/play_store.png"/>
        <img className="appstore" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/m/app_store.png"/>
        </span>
        </div>
      ...
      <div class="footer-logo">
                        ...
                        <span><b> AJFoods</b></span>
                        <div class="Tech">© 2024 Bundl Technologies<br></br> Pvt. Ltd</div>
                    </div>
      <div>
        <h4>Company</h4>
        <p>About</p>
